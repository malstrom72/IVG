# Capturing IVGFiddle Preview Evidence

Use these steps to record a screenshot or GIF of the IVGFiddle preview when preparing release notes or manual verification logs.
...
7. Save the asset under `tools/ivgfiddle-vscode/media/docs/` using a descriptive filename like `preview-success.png` or `preview-refresh.gif`.
8. Reference the asset in documentation or release notes using a relative path (for example, `![IVGFiddle preview](media/docs/preview-success.png)`).
