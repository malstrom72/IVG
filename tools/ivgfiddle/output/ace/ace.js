			...
			g = function (e, t) {
						...
						return (
							...
							!r && !a && !f && !o && !u && !l
								...
								: ((w = !0),
									(a && !o && !u && !f && !l) || S
										? t.onTextInput(a)
										: t.onTextInput(a, { extendLeft: o, extendRight: u, restoreStart: f, restoreEnd: l }),
									(w = !1),
									(T = e),
									(N = i),
									(C = s),
				...
				var U = function (e) {
						...
						((r.end.row = r.start.row),
							...
							b.useTextareaForIME
								? ((T = n.value = ""), (N = 0), (C = 0))
								: (n.msGetInputContext && (b.context = n.msGetInputContext()), n.getInputContext && (b.context = n.getInputContext())));
					},
					z = function () {
				...
				for (var f = 0; f < o.length - 1; f++)
					n[f] === w
						...
						: a[f] === y && ((n[f] > T && n[f] < O) || n[f] === E || n[f] === H)
							? (a[f] = t.ON_R)
							: f > 0 && i[f - 1] === "\u0644" && /\u0622|\u0623|\u0625|\u0627/.test(i[f]) && ((a[f - 1] = a[f] = t.R_H), f++);
					...
					((this.line = this.line.replace(/\t|[\u1100-\u2029, \u202F-\uFFE6]/g, function (e, t) {
						...
						this.isRtlDir &&
							((this.fontMetrics.$main.textContent =
								this.line.charAt(this.line.length - 1) == r.DOT ? this.line.substr(0, this.line.length - 1) : this.line),
					...
					return (
						r > 0 && i[r - 1] % 2 !== 0 && i[r] % 2 === 0
							...
							: r > 0 && i[r - 1] % 2 === 0 && i[r] % 2 !== 0
								...
								: (this.isRtlDir && r === i.length - 1 && s === 0 && i[r - 1] % 2 === 0) || (!this.isRtlDir && r === 0 && i[r] % 2 !== 0)
					...
					for (var a = 0; a < n.length; a++) {
						...
						(Array.isArray(f.token)
							? f.token.length == 1 || c == 1
								? (f.token = f.token[0])
								: c - 1 != f.token.length
									? (this.reportError("number of classes and regexp groups doesn't match", { rule: f, groupCount: c - 1 }),
										(f.token = f.token[0]))
			...
			((this.normalizeRules = function () {
				function i(s) {
					...
					for (var u = 0; u < o.length; u++) {
						...
						a.keywordMap &&
							((a.token = this.createKeywordMapper(a.keywordMap, a.defaultToken || "text", a.caseInsensitive)), delete a.defaultToken);
					}
				}
				var n = 0,
					r = this.$rules;
	...
	ace.define("ace/mode/behaviour/cstyle", [], function (e, t, n) {
		...
		var r = e("../../lib/oop"),
			...
			h = function (e) {
				var t = -1;
				e.multiSelect &&
					((t = e.selection.index), l.rangeCount != e.multiSelect.rangeCount && (l = { rangeCount: e.multiSelect.rangeCount }));
				if (l[t]) return (f = l[t]);
				f = l[t] = {
		...
		((function () {
			(r.implement(this, s),
				...
				(this.removeInLine = function (e, t, n) {
					...
					return (
						this.applyDelta({ start: r, end: i, action: "remove", lines: this.getLinesForRange({ start: r, end: i }) }, !0),
						this.clonePos(r)
					);
				}),
			...
			((this.findMatchingBracket = function (e, t) {
				...
				(this.getBracketRange = function (e) {
					var t = this.getLine(e.row),
						...
						o = s && s.match(/([\(\[\{])|([\)\]\}])/);
					o ||
						((s = t.charAt(e.column)), (e = { row: e.row, column: e.column + 1 }), (o = s && s.match(/([\(\[\{])|([\)\]\}])/)), (n = !1));
					if (!o) return null;
					if (o[1]) {
			...
			function () {
				...
				(r.implement(this, u),
					...
					(this.onChange = function (e) {
						...
						(!this.$fromUndo &&
							...
							(t &&
								t.length &&
								(this.$undoManager.add({ action: "removeFolds", folds: t }, this.mergeUndoDeltas), (this.mergeUndoDeltas = !0)),
					...
					(this.undoChanges = function (e, t) {
						...
						(!t &&
							this.$undoSelect &&
							(e.selectionBefore ? this.selection.fromJSON(e.selectionBefore) : this.selection.setRange(this.$getUndoSelection(e, !0))),
							(this.$fromUndo = !1));
					}),
					(this.redoChanges = function (e, t) {
						...
						(!t &&
							this.$undoSelect &&
							(e.selectionAfter ? this.selection.fromJSON(e.selectionAfter) : this.selection.setRange(this.$getUndoSelection(e, !1))),
							(this.$fromUndo = !1));
					}),
					...
					(this.adjustWrapLimit = function (e, t) {
						...
						return r != this.$wrapLimit && r > 1
							? ((this.$wrapLimit = r),
								(this.$modified = !0),
								this.$useWrapMode &&
									(this.$updateWrapData(0, this.getLength() - 1), this.$resetRowCache(0), this._signal("changeWrapLimit")),
								!0)
							: !1;
					}),
						...
						if (u != 0)
							if (n === "remove") {
								...
								if (l) {
									...
									(v == 0
										? ((l = l.split(r.row, r.column)), l && (l.shiftRow(u), l.addRemoveChars(o, 0, i.column - r.column)))
				...
				((this.$computeWrapSplits = function (e, r, i) {
					...
					(this.documentToScreenPosition = function (e, t) {
						...
						return (
							this.lineWidgets && this.lineWidgets[u] && this.lineWidgets[u].rowsAbove && (r += this.lineWidgets[u].rowsAbove),
				...
				exec: function (e) {
					...
					for (var o = 0; o < r.length; o++)
						(o == r.length - 1 && (r[o].end.row !== t || r[o].end.column !== n) && i.push(new s(r[o].end.row, r[o].end.column, t, n)),
							o === 0
								? (r[o].start.row !== 0 || r[o].start.column !== 0) && i.push(new s(0, 0, r[o].start.row, r[o].start.column))
				...
				(r.implement(this, d),
					...
					(this.startOperation = function (e) {
						...
						(e || ((this.previousCommand = null), (e = {})),
							...
							(this.curOp = this.session.curOp = { command: e.command || {}, args: e.args, scrollTop: this.renderer.scrollTop }),
								...
								(Array.isArray(n) ? n.length == 1 && (r = "ace_error_bracket") : (n = [n]),
									n.length == 2 &&
										(p.comparePoints(n[0].end, n[1].start) == 0
											...
											: p.comparePoints(n[0].start, n[1].end) == 0 && (n = [p.fromPoints(n[1].start, n[0].end)])),
									(t.$bracketHighlight = {
										ranges: n,
					...
					(this.insert = function (e, t) {
						...
						if (this.getBehavioursEnabled() && !t) {
							...
							s &&
								(e !== s.text && (this.inVirtualSelectionMode || ((this.session.mergeUndoDeltas = !1), (this.mergeNextCommand = !1))),
								(e = s.text));
						}
					...
					(this.autoIndent = function () {
						...
						for (var h = n; h <= r; h++)
							(h > 0 && ((s = e.getState(h - 1)), (o = e.getLine(h - 1)), (u = t.getNextLineIndent(s, o, c))),
								...
								(f = t.$getIndent(a)),
								u !== f &&
									(f.length > 0 && ((l = new p(h, 0, h, f.length)), e.remove(l)), u.length > 0 && e.insert({ row: h, column: 0 }, u)),
								t.autoOutdent(s, e, h));
					}),
									...
									g &&
										((c = n.replace(new RegExp(s.escapeRegExp(p[d]), "i"), function (e) {
											...
											return (
												e.toUpperCase() == e
													? (t = t.toUpperCase())
													: e.charAt(0).toUpperCase() == e.charAt(0) && (t = t.substr(0, 0) + p[v].charAt(0).toUpperCase() + t.substr(1)),
												t
											);
										})),
										this.insert(c),
					...
					for (; l <= f; l++)
						((d.start.row = d.end.row = l),
							...
							this.drawSingleLineMarker(
								t,
								d,
								i + (l == a ? " ace_start" : "") + " ace_br" + e(l == a || (l == a + 1 && n.start.column), c < h, h > p, l == f),
								s,
								l == f ? 0 : 1,
								o,
							));
				...
				(this.setShowInvisibles = function (e) {
					return this.showInvisibles == e
						...
						: ((this.showInvisibles = e),
							typeof e == "string"
								? ((this.showSpaces = /tab/i.test(e)), (this.showTabs = /space/i.test(e)), (this.showEOL = /eol/i.test(e)))
				...
				(this.$renderChanges = function (e, t) {
					...
					if (e & this.CHANGE_SCROLL) {
						((this.$changedLines = null),
							...
							this.$showGutter &&
								(e & this.CHANGE_GUTTER || e & this.CHANGE_LINES ? this.$gutterLayer.update(n) : this.$gutterLayer.scrollLines(n)),
							this.$markerBack.update(n),
							this.$markerFront.update(n),
							this.$cursorLayer.update(n),
							this.$moveTextAreaToCursor(),
					...
					(e & this.CHANGE_TEXT
						? ((this.$changedLines = null), this.$textLayer.update(n), this.$showGutter && this.$gutterLayer.update(n))
						: e & this.CHANGE_LINES
							? (this.$updateLines() || (e & this.CHANGE_GUTTER && this.$showGutter)) && this.$gutterLayer.update(n)
							: e & this.CHANGE_TEXT || e & this.CHANGE_GUTTER
								? this.$showGutter && this.$gutterLayer.update(n)
								: e & this.CHANGE_CURSOR && this.$highlightGutterLine && this.$gutterLayer.updateLineHighlight(n),
		...
		(function () {
			(r.implement(this, s),
				...
				(this.emit = function (e, t) {
					try {
						(t.data && t.data.err && (t.data.err = { message: t.data.err.message, stack: t.data.err.stack, code: t.data.err.code }),
		...
		((function () {
			((this.getRowLength = function (e) {
				...
				(this.measureWidgets = function (e, t) {
					...
					(i != Infinity && (this.session._emit("changeFold", { data: { start: { row: i } } }), (this.session.lineWidgetWidth = null)),
						(this.session._changedWidgets = []));
				}),
