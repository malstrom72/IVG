...
- [ ] VS Code user acceptance:
- [ ] Preparation: open an IVG workspace with include assets, enable **IVGFiddle › Includes: Watchers Enabled** and **Manifest Enabled**, and make sure the preview is visible.
